...
"""
Current running version of the code with basinhopping implemented rather than BFGS
"""
"""
...
def rac(ls, Es, E_range, guess, pr):
    ...
    minimizer_kwarg = {"method": "BFGS", "args": (ks, lbs, sigmas, cs)}
    res = basinhopping(racu.chi, ps, minimizer_kwargs=minimizer_kwarg, niter=50)
    ps = res.x
    if pr > 2:
